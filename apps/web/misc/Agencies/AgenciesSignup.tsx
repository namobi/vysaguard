...
interface AgenciesSignupProps {
  onNavigate: (view: 'landing' | 'applicant' | 'agency' | 'agency-signup') => void;
}

export const AgenciesSignup: React.FC<AgenciesSignupProps> = ({ onNavigate }) => {
  return (
      ...
      <section className="pt-32 pb-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button size="lg" onClick={() => onNavigate('agency')}>
              Sign up as an Agent
            </Button>
